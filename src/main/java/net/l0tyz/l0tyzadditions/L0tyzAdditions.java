...
@Mod(L0tyzAdditions.MOD_ID)
public class L0tyzAdditions {
    // Define mod id in a common place for everything to reference
    public static final String MOD_ID = "l0tyzadditions";
    // Directly reference a slf4j logger
    public static final Logger LOGGER = LogUtils.getLogger();

    public L0tyzAdditions(FMLJavaModLoadingContext context)  {
